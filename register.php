...
if(isset($_POST['fullname']) && isset($_POST['gender']) && isset($_POST['dob']) && isset($_POST['bloodgroup']) && isset($_POST['mobile']) && isset($_POST['email']) && isset($_POST['state']) && isset($_POST['town']) && isset($_POST['username']) && isset($_POST['password'])){
	if(!empty($_POST['fullname']) && !empty($_POST['gender']) && !empty($_POST['dob']) && !empty($_POST['bloodgroup']) && !empty($_POST['mobile']) && !empty($_POST['email']) && !empty($_POST['state']) && !empty($_POST['username']) && !empty($_POST['password']) ){
		...
		if($query_run){
			...
			echo '</script>';
			$to_email=$email;
			$subject='Resitration reg.';
			$message='Welcome to BBMS. Thank you for registering with us. Find the link below to locate hospitals near you:https://www.google.com/maps/d/drive?state=%7B%22ids%22%3A%5B%2210Mxg8bxDTxO9SniEM29v0RbE7Yxa47OA%22%5D%2C%22action%22%3A%22open%22%2C%22userId%22%3A%22100219360229845384482%22%7D&usp=sharing';
			$headers='From: nss.vce.hyd@gmail.com';
...
<div class="col-12" style="height: 350px">
	...
	<img class="myFrontPic col-12" src="images/7.jpg" style="height: 350px;">
</div>
	<div class="col-12" style="overflow: auto; padding: 0 20% 0 20%;">
		<div class="col-12" style="text-align: left; padding: 5%; background-color: rgb(217, 219, 224);">
			<form action="register.php" method="post">
				...
				Aadhaar(required)<span style="color: red;">*</span><br>
				<input class="in" type="file" name="aadhaar" placeholder="Upload Aadhaar" required style="color: black;"><br><br>
